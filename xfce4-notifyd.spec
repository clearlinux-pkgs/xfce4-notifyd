...
Source0  : https://archive.xfce.org/src/apps/xfce4-notifyd/0.8/xfce4-notifyd-0.8.0.tar.bz2
...
%prep
%setup -q -n xfce4-notifyd-0.8.0
cd %{_builddir}/xfce4-notifyd-0.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676255004
