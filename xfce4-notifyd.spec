...
Version  : 0.6.2
Release  : 21
URL      : https://archive.xfce.org/src/apps/xfce4-notifyd/0.6/xfce4-notifyd-0.6.2.tar.bz2
Source0  : https://archive.xfce.org/src/apps/xfce4-notifyd/0.6/xfce4-notifyd-0.6.2.tar.bz2
...
%prep
%setup -q -n xfce4-notifyd-0.6.2
cd %{_builddir}/xfce4-notifyd-0.6.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609290815
...
cp %{_builddir}/xfce4-notifyd-0.6.2/COPYING %{buildroot}/usr/share/package-licenses/xfce4-notifyd/dfac199a7539a404407098a2541b9482279f690d
%make_install
