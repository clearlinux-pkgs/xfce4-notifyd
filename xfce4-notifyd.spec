...
Source0  : https://archive.xfce.org/src/apps/xfce4-notifyd/0.6/xfce4-notifyd-0.6.4.tar.bz2
...
%prep
%setup -q -n xfce4-notifyd-0.6.4
cd %{_builddir}/xfce4-notifyd-0.6.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662499358
