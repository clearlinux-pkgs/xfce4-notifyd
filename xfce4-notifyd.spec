...
Source0  : https://archive.xfce.org/src/apps/xfce4-notifyd/0.9/xfce4-notifyd-0.9.4.tar.bz2
...
%prep
%setup -q -n xfce4-notifyd-0.9.4
cd %{_builddir}/xfce4-notifyd-0.9.4
pushd ..
cp -a xfce4-notifyd-0.9.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707671850
