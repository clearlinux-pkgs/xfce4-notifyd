...
Source0  : https://archive.xfce.org/src/apps/xfce4-notifyd/0.7/xfce4-notifyd-0.7.2.tar.bz2
...
%prep
%setup -q -n xfce4-notifyd-0.7.2
cd %{_builddir}/xfce4-notifyd-0.7.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674682558
