...
Version  : 0.7.3
Release  : 26
URL      : https://archive.xfce.org/src/apps/xfce4-notifyd/0.7/xfce4-notifyd-0.7.3.tar.bz2
Source0  : https://archive.xfce.org/src/apps/xfce4-notifyd/0.7/xfce4-notifyd-0.7.3.tar.bz2
...
%prep
%setup -q -n xfce4-notifyd-0.7.3
cd %{_builddir}/xfce4-notifyd-0.7.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675390365
