...
Source0  : https://archive.xfce.org/src/apps/xfce4-notifyd/0.9/xfce4-notifyd-0.9.3.tar.bz2
...
%prep
%setup -q -n xfce4-notifyd-0.9.3
cd %{_builddir}/xfce4-notifyd-0.9.3
pushd ..
cp -a xfce4-notifyd-0.9.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698075343
